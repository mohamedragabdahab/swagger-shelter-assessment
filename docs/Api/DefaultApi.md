# Mohamed\SearchShelter\SwaggerClient\DefaultApi
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Mohamed\SearchShelter\SwaggerClient\Model\Animal**](../Model/Animal.md)| Animal object that needs to be added to the store |
...
$body = new \Mohamed\SearchShelter\SwaggerClient\Model\Shelter(); // \Mohamed\SearchShelter\SwaggerClient\Model\Shelter | Shelter object that needs to be added to the store
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Mohamed\SearchShelter\SwaggerClient\Model\Shelter**](../Model/Shelter.md)| Shelter object that needs to be added to the store |
...
$body = new \Mohamed\SearchShelter\SwaggerClient\Model\Worker(); // \Mohamed\SearchShelter\SwaggerClient\Model\Worker | Worker object that needs to be added to the store
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Mohamed\SearchShelter\SwaggerClient\Model\Worker**](../Model/Worker.md)| Worker object that needs to be added to the store |
...
# **listShelterAnimals**
> \Mohamed\SearchShelter\SwaggerClient\Model\Animal listShelterAnimals($shelter_id)
...
[**\Mohamed\SearchShelter\SwaggerClient\Model\Animal**](../Model/Animal.md)
...
# **listShelterWorkers**
> \Mohamed\SearchShelter\SwaggerClient\Model\Worker listShelterWorkers($shelter_id)
...
[**\Mohamed\SearchShelter\SwaggerClient\Model\Worker**](../Model/Worker.md)
