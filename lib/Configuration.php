...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://virtserver.swaggerhub.com/mohamedragabdahab/Animal-Salvation-Army/1.0.0';
    ...
    {
        $report  = 'PHP SDK (Mohamed\SearchShelter\SwaggerClient) Debug Report:' . PHP_EOL;
